...
import com.miportfolio.NJRG.Security.Dto.JwtDto;
import com.miportfolio.NJRG.Security.Dto.LoginUsuario;
import com.miportfolio.NJRG.Security.Dto.NuevoUsuario;
import com.miportfolio.NJRG.Security.Entity.Rol;
import com.miportfolio.NJRG.Security.Entity.Usuario;
...
public class AuthController {
    ...
    public ResponseEntity<?> nuevo(@Valid @RequestBody NuevoUsuario nuevoUsuario, BindingResult bindingResult){
        ...
        if(usuarioService.existsByNombreUsuario(nuevoUsuario.getNombreUsuario()))
            return new ResponseEntity(new Mensaje("Ese usuario ya esta registrado, intente otro nombre."),HttpStatus.BAD_REQUEST);
